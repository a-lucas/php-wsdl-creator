...
require_once(dirname(__FILE__).'/class.soapserver.php');
...
class PhpWsdl{
    ...
    public function IsSoapRequest(){
        ...
        $f = fopen("debugCode", "w");
        fwrite($f, "is it a soap request? " . $this->IsSoapRequest()."\n");
        fclose($f);
    ...
    public function RunServer($wsdlFile=null,$class=null,$andExit=true,$forceNoWsdl=false){
        ...
        if(self::CallHook(
            ...
            $this->SoapServer=new PhpSoapServer(
                $wsdlFile,
                $temp
            );
    ...
    public function TranslateTargetType($type){
        ...
        switch(get_class($t)){
            case 'PhpWsdlEnum':
                return self::TranslateType($t->Type);
                break;
            default:
                return self::TranslateType($type);
                break;
